...
export class MenuRenderer {
  ...
  private drawHelp(g: CanvasRenderingContext2D, width: number, height: number): void {
    const lines = [
      ...
      '仲間      : 倒した魔物がときどき起き上がって仲間になる（最大3体）。T で作戦切替',
      '            ガンガンいこうぜ / いのちだいじに / ついてこい。特技はレベルで覚える',
      '店        : 値札付きの品を拾って店主（ガーゴイル）にぶつかると支払い。店内では「売る」',
      '            未払いのまま店を出ると「どろぼう」でガーゴイルが襲ってくる',
      'リレミト  : リレミトの巻物を読むと拠点に帰還できる（持ち物は持ち帰れる）',
      '図鑑      : M キー',
      'テーマ    : 1〜2F 洞窟 / 3〜4F 地底湖 / 5〜6F 氷の洞窟 / 7〜8F 火山 / 9F〜 天空',
      '            水や空は歩けないが投げ物は飛び越える。氷は滑る（炎で溶ける）。溶岩は歩けるが焼ける',
      'モンハウ  : 敵とアイテムが詰まった部屋。踏み込むと眠っていた敵が一斉に起きる',
      '罠        : 2F〜。踏むまで見えない（落とし穴・地雷・睡眠ガス・ワープ・錆び・召喚）。罠見破りの巻物で可視化',
      '番人・鍛冶: 4F〜階段の部屋に眠る番人（隣接で起床、倒すと戦利品）。鍛冶屋にぶつかるとゴールドで装備+1',
      '地形変化  : 地底湖は周期的に満潮で橋が沈む。天空は歩いた回廊が崩れ、しばらくすると戻る',
      '岩・跳ね床: 岩は押せる（水に落とすと足場に）。跳ね床は壁まで飛ばされる。泉・石碑もある',
